...
/*initialize variables then display today's date under h1 tag*/ 
var thisDate = new Date();
var dateString = thisDate.toLocaleDateString();//todays local date
var dateHTML = "<h2>" + dateString + "</h2>";

//display today's date and weekly events before the closing tag
var thisDay = thisDate.getDay();//variable to get day week number
var eventHTML = getEvent(thisDay);//create variable for event then call function for the weekday
//insert the date and events variable before the aside element's closing tag
